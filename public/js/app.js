...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuejs_paginate__ = __webpack_require__(29);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	data: (_data = {
		...
		merchantCategoryId: '',
		merchantSubId: ''
	}, _defineProperty(_data, 'products', {}), _defineProperty(_data, 'productLastPage', 1), _defineProperty(_data, 'query', {
		...
		per_page: 5,
		direction: 'asc'
	}), _defineProperty(_data, 'sortBy', ['desc', 'asc']), _defineProperty(_data, 'chunk', 3), _defineProperty(_data, 'price_start', ''), _defineProperty(_data, 'price_end', ''), _defineProperty(_data, 'showNumberProducts', [10, 15, 20, 25, 30]), _defineProperty(_data, 'windowLocation', window.location.origin + '/'), _defineProperty(_data, 'loading', true), _data),
	...
	methods: {
		...
		clickCallback: function clickCallback(pageNum) {
			...
			this.products = [{
				data: [{ product: [{
						photos: [{ is_primary: true }, { path: '' }]
					}, {
						prices: [{ is_primary: true }, { price: '' }]
					}]
				}]
		...
		fetchedProductData: function fetchedProductData() {
			...
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.windowLocation + '/api/products' + ('?mainCategoryId=' + this.mainCategoryId + '&merchantCategoryId=' + this.merchantCategoryId + '&merchantSubId=' + this.merchantSubId + '&provCode=' + this.province + '&citymunCode=' + this.city + '&per_page=' + this.query.per_page + '&page=' + this.query.page + '&sortBy=' + this.query.direction + '&fieldName=' + this.query.fieldName)).then(function (response) {
				...
				__WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(vm.$data, 'loading', false);
	...
	watch: {
		...
		province: function province() {
			...
			if (this.province != '') {
				...
				__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(window.location.origin + '/api/cities/' + this.province).then(function (response) {
